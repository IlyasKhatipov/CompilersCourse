...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_top_list = 34,                  /* top_list  */
  YYSYMBOL_top_item = 35,                  /* top_item  */
  YYSYMBOL_class_decl = 36,                /* class_decl  */
  YYSYMBOL_class_opt_ext = 37,             /* class_opt_ext  */
  YYSYMBOL_class_body = 38,                /* class_body  */
  YYSYMBOL_class_member = 39,              /* class_member  */
  YYSYMBOL_var_decl = 40,                  /* var_decl  */
  YYSYMBOL_maybe_type = 41,                /* maybe_type  */
  YYSYMBOL_method_decl = 42,               /* method_decl  */
  YYSYMBOL_method_body = 43,               /* method_body  */
  YYSYMBOL_method_member = 44              /* method_member  */
};
...
{
       0,    55,    55,    67,    68,    75,    76,    77,    81,    95,
      96,   100,   101,   108,   109,   113,   122,   123,   127,   139,
     140,   147
};
#endif
...
#line 68 "parser.y"
        ...
        if ((yyvsp[0].node)) (yyval.vec)->push_back((yyvsp[0].node));
    }
...
#line 81 "parser.y"
                                                     {
        auto cn = new ClassNode((yyvsp[-4].str) ? string((yyvsp[-4].str)) : string());
        if ((yyvsp[-3].str)) cn->extendsName = string((yyvsp[-3].str));
        if ((yyvsp[-1].vec)) {
            for (ASTNode* m : *(yyvsp[-1].vec)) cn->members.emplace_back(unique_ptr<ASTNode>(m));
            delete (yyvsp[-1].vec);
        }
...
#line 113 "parser.y"
                                   {
        auto vn = new VarNode((yyvsp[-2].str) ? string((yyvsp[-2].str)) : string(), (yyvsp[-1].str) ? string((yyvsp[-1].str)) : string());
...
#line 127 "parser.y"
                                                       {
        auto mn = new MethodNode((yyvsp[-5].str) ? string((yyvsp[-5].str)) : string());
        if ((yyvsp[-1].vec)) {
            for (ASTNode* b : *(yyvsp[-1].vec)) mn->body.emplace_back(unique_ptr<ASTNode>(b));
            delete (yyvsp[-1].vec);
        }
        if ((yyvsp[-5].str)) free((yyvsp[-5].str));
        (yyval.node) = mn;
    }
